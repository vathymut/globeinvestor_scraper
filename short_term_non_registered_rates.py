...
# Get the urls
url_pg1 = r'http://www.globeinvestor.com/servlet/Page/document/v5/data/rates?order=a&pageType=gic_short&sort=FIN_NAME&page=1&tax_indicator=N'
url_pg2 = r'http://www.globeinvestor.com/servlet/Page/document/v5/data/rates?order=a&pageType=gic_short&sort=FIN_NAME&page=2&tax_indicator=N'
url_pg3 = r'http://www.globeinvestor.com/servlet/Page/document/v5/data/rates?order=a&pageType=gic_short&sort=FIN_NAME&page=3&tax_indicator=N'
urls = ( url_pg1, url_pg2, url_pg3 )

if __name__ == '__main__':
    write_info_to_csv( urls, all_xpaths, colnames, prefix = 'gic-short-term-non-registered' )
    date_today = str( datetime.date.today() )
    kwargs = dict( rate_type = 'gic-short-term-non-registered', date = date_today )
